      ...
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          <Image
            ...
            width={56}
            height={56}
            style={{ borderRadius: 12, margin: '0 auto 10px' }}
          />
          <div style={{
        ...
        {kycStep ? (
          <div>
            ...
            <p style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.6, marginBottom: 20 }}>
              NzemFi uses biometric KYC to ensure one account per person and protect the NZM token economy.
              We use Eyeris — we store only an anonymous face hash, never your image.
            </p>
            <div style={{
              ...
              <div style={{ fontSize: 14, fontWeight: 500, marginBottom: 6 }}>
                Enable Camera for Liveness Check
              </div>
              <div style={{ fontSize: 12, color: 'var(--text-secondary)' }}>
                Quick 5-second scan. Prevents duplicate accounts.
              </div>
            </div>
            {error && (
              <div style={{
                color: 'var(--error)', fontSize: 13, marginBottom: 14,
                padding: '10px 14px', background: 'rgba(239,68,68,0.08)', borderRadius: 8,
              }}>
                {error}
              </div>
            )}
          ...
          <>
            ...
            {mode === 'forgot' && (
              <div>
                ...
                {error && (
                  <div style={{ color: 'var(--error)', fontSize: 13, marginBottom: 14 }}>{error}</div>
                )}
                <button
                  className="btn-primary"
            ...
            {mode === 'login' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                <button
                  ...
                  style={{
                    background: 'none', border: 'none',
                    color: 'var(--nzm-purple-lighter)', fontSize: 12,
